(function(a){
    a.fn.webwidget_scroller_tab=function(p){
        ...
        var s_t_i=p&&p.scroller_time_interval?p.scroller_time_interval:"1000";
        var s_w_p=p&&p.scroller_window_padding?p.scroller_window_padding:"5";
        var s_w_w=p&&p.scroller_window_width?p.scroller_window_width:"800";
        var s_w_h=p&&p.scroller_window_height?p.scroller_window_height:"500";
